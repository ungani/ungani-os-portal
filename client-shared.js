  ...
  function injectSharedStyles() {
    ...
    style.textContent = `
      ...
      * {
      ...
      /* Team Chat's own panel/bubble/toast styling now lives in
         team-chat-shared.js (self-injected, ID-scoped to
         #unganiTeamChatPanel) - it's shared with client.html and
         my-team-chat.html, which don't have these --ungani-* custom
